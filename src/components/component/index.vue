<template>
  <div class="mianCont" :style="{'--color':commandObject.color}">
    <div class="hdNav" >
      <div class="hdLeft">
        <div class="name">{{sectionName}}数据看板</div>
    ...
    <div class="dataCont" v-show="!showMask" :style="isSmallScreen?'padding: 0 0 0 0;':'padding: 0 50px 0 ;'" @click="showMask=false">
      <div class="left_cont topData">
        
        <div class="data_card">
          <div class="left_item">
            <div class="left_item_icon"><img :src="commandObject.analyzingIcon.allpepole" alt=""></div>
            <div class="left_item_text">
               <div class="name_tips">
                 <div class="left_item_name">{{commandObject.analyzing}}总数 (个)</div>
          ...
          <div class="left_item">
            <div class="left_item_icon"><img :src="commandObject.analyzingIcon.allnum" alt=""></div>
            <div class="left_item_text">
               <div class="name_tips">
          ...
          <div class="left_item">
            <div class="left_item_icon"><img :src="commandObject.analyzingIcon.leave" alt=""></div>
            <div class="left_item_text">
               <div class="name_tips">
          ...
          <div class="left_item">
            <div class="left_item_icon"><img :src="commandObject.analyzingIcon.passwrold" alt=""></div>
            <div class="left_item_text">
               <div class="name_tips">
          ...
          <div class="left_item">
            <div class="left_item_icon"><img :src="commandObject.analyzingIcon.book" alt=""></div>
            <div class="left_item_text">
               <div class="name_tips">
          ...
          <div class="left_item">
            <div class="left_item_icon"><img :src="commandObject.analyzingIcon.evaluate" alt=""></div>
            <div class="left_item_text">
               <div class="name_tips">
          ...
          <div class="left_item">
            <div class="left_item_icon"><img :src="commandObject.analyzingIcon.study" alt=""></div>
            <div class="left_item_text">
               <div class="name_tips">
          ...
          <div class="left_item">
            <div class="left_item_icon"><img :src="commandObject.analyzingIcon.sussece" alt=""></div>
            <div class="left_item_text">
               <div class="name_tips">
          ...
          <div class="part_table part_tableNew">
            <div class="partName hasRight">
              <div class="lf" v-show="chartCurrent == '1'">
                <img :src="commandObject.exam_num" alt="">
                <div>各单位考试人数</div>
              </div>
    ...
    <!-- 第二个组装图 -->
        ...
        <div class="part_table part_table_new_right ">
          <div class="partName">
            <img :src="commandObject.work_type" alt="">
            <div>在场工种总人数</div>
          </div>
    ...
    <div class="dataCont" v-show="!showMask" :style="isSmallScreen?'padding: 0 0 40px 0;':'padding: 0 50px 40px 50px;'" @click="showMask=false">
        ...
        <div class="left_cont row2" style="padding-bottom:30px;">
          ...
          <div class="part_table" style="height:100%;">
            <div class="partName" style="display:flex;justify-content: space-between;">
              <div class="partName">
                <img :src="commandObject.part" alt="">
                <div>各单位学习情况</div>
              </div>
            ...
            <div class="partItem" v-for="item in learnData" :key="item.id">
              <div class="name">{{item.name=="直属班组群"? '全队总数':item.name}} </div>
          ...
          <div class="part_table part_table_progress">
            <div class="partName" style="display:flex;justify-content: space-between;">
              <div class="partName" >
                <img :src="commandObject.part" alt="">
                <div>学习次数排行榜-{{commandObject.present}}</div>
              </div>
              <div class="show_hover" v-if="commandObject.present!='大队'">
                <el-tooltip class="item" effect="dark" content="上周一至周日，新增学习次数排行前五名"  placement="top">
                  <div class="hovers">指标解析</div>
                </el-tooltip>
              </div>

               <div v-if="commandObject.present=='大队'" class="show_hover"><el-tooltip class="item" effect="dark"  placement="top">
                  <div class="hovers">指标解析</div>
                  <div slot="content">
                      <span>上周一至周日，新增学习次数排行前五名</span><br/><br/>
                      <span>没有大队的班组自动归为直属班组群</span>
                  </div>
                  </el-tooltip>
                </div>
            </div>
      ...
      <div class="right_cont row2">
        <div class="part_table belong"  >
          <div class="partName" style="margin-bottom: 20px;">
            <img :src="commandObject.list" alt="">
            <div>下属单位列表</div>
          </div>
    ...
    <div class="" v-if="showMask">
        <menus @msg="getData"></menus>
    </div>
  </div>
</template>

<script>
  import {totalData,learnInfo,studyRank,studyInfo,workType,branchList,branchData} from '@/http/home.js'
  // var echarts = require('echarts');
  import menus from '@/components/component/menu.vue'
  export default {
    props: {
    commandObject:{
    ...
    methods:{
      ...
      getTotalData(){
        ...
        totalData(that.params).then((res)=>{
          if(res.data.code == 200){
            that.sectionName=res.data.data.unitName
      ...
      getSectionInfo(id, name){
        ...
        this.$router.push({
          path:that.commandObject.path,
          query:{
            id: id,
            type: that.commandObject.type
          }
        })
      },
      // 获取今天日期
          ...
          series: [
            {
              ...
              itemStyle: {
                color: this.$echarts.graphic.LinearGradient(0, 0, 0, 1, [
                  { offset: 0, color:that.commandObject.chartColor_top },
                  { offset: 1, color:that.commandObject.chartColor_bottom }
                ]),
              },
